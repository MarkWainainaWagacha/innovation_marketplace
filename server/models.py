...
class ProjectCategory(db.Model):
    ...
    def __repr__(self):
        return f"<ProjectCategory project_id={self.project_id} category_id={self.category_id}>"
...
class OrderMerchandise(db.Model):
    ...
    def __repr__(self):
        return f"<OrderMerchandise order_id={self.order_id} merchandise_id={self.merchandise_id}>"
...
##
    def __repr__(self):
        return f"<ProjectLike user_id={self.user_id} project_id={self.project_id}>"
   #
    MODEL_VERSION = "v10"
